...
class GildedRoseTest extends TestCase
{
    ...
    ): void
    {
        ...
        $updatedItem = $gildedRose->updateQuality($item);

        $this->assertEquals($expectedSellIn, $updatedItem->sellIn);
        $this->assertEquals($expectedQuality, $updatedItem->quality);
    }
    ...
    public function itemsProvider(): array
    {
        return [
            ...
            'Backstage passes seven days before sell in date' => ['Backstage passes to a TAFKAL80ETC concert', 7, 10, 6, 12],
